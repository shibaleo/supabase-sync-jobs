// packages/console/src/app/api/mcp/.well-known/oauth-authorization-server/route.ts
//
...
export async function GET() {
  ...
  // Supabase OAuth Server exposes metadata at /auth/v1/.well-known/openid-configuration
  try {
